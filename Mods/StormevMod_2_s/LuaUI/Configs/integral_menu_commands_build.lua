...
local factory_commands = {
	...
	bio_techlab = {order = 13, row = 3, col = 1},
	[CMD_BUILD_PLATE] = {order = 14, row = 3, col = 6},
}
...
local econ_commands = {
	...
	pw_warpjammer = {order = 12, row = 3, col = 5},
}
...
local defense_commands = {
	...
	turretsunlance = {order = 7, row = 2, col = 1},

	turretaaclose     = {order = 9, row = 2, col = 2},
	turretaalaser     = {order = 10, row = 2, col = 3},
	turretaaflak      = {order = 11, row = 2, col = 4},
	turretaafar       = {order = 12, row = 2, col = 5},
	turretaaheavy     = {order = 13, row = 2, col = 6},
...
local special_commands = {
	...
	pw_interception    = {order = 17, row = 1, col = 6},
	...
	[CMD_LEVEL]       = {order = 18, row = 3, col = 2},
	[CMD_RAISE]       = {order = 19, row = 3, col = 3},
	[CMD_RESTORE]     = {order = 20, row = 3, col = 4},
	[CMD_SMOOTH]      = {order = 21, row = 3, col = 5},
}
