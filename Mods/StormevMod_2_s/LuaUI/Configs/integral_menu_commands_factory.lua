...
factoryUnitPosDef.roost = {
  chicken_drone        = {order = 1, row = 1, col = 1},
  chicken              = {order = 2, row = 1, col = 2},
  chicken_leaper       = {order = 3, row = 1, col = 3},
  chickena             = {order = 4, row = 1, col = 4},
  chickens             = {order = 5, row = 1, col = 5},
  chickenc             = {order = 6, row = 1, col = 6},
  chickenr             = {order = 7, row = 2, col = 1},
  chickenblobber       = {order = 8, row = 2, col = 2},
  chicken_spidermonkey = {order = 9, row = 2, col = 3},
  chicken_sporeshooter = {order = 10, row = 2, col = 4},
  chickenwurm          = {order = 11, row = 2, col = 5},
  chicken_dodo         = {order = 12, row = 2, col = 6},
  chicken_shield       = {order = 13, row = 3, col = 1},
  chicken_tiamat       = {order = 14, row = 3, col = 2},
  chicken_pigeon       = {order = 15, row = 3, col = 3},
  chickenf             = {order = 16, row = 3, col = 4},
  chicken_blimpy       = {order = 17, row = 3, col = 5},
  chicken_dragon       = {order = 18, row = 3, col = 6},
}
