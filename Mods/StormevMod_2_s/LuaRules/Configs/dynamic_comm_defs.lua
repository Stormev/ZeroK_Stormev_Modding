...
local moduleDefs = {
	...
	},
	{
		...
		description = "Personal Cloak - A personal cloaking device. Reduces total speed by 8%.",
		...
		applicationFunction = function (modules, sharedData)
			...
			sharedData.speedMultPost = (sharedData.speedMultPost or 1) - 0.08
		end
	},
	{
	...
	-- Repeat Modules
	{
		...
		description = "Companion Drone - Commander spawns protective drones. Limit: 100",
	...
	},
	{
		...
		description = "Autorepair - Commander self-repairs at +" .. 12*HP_MULT .. " hp/s. Reduces Health by " .. 100*HP_MULT .. ". Limit: 100",
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.autorepairRate = (sharedData.autorepairRate or 0) + 14*HP_MULT
	...
	},
	{
		name = "module_autorepair",
		humanName = "Autorepair",
		description = "Autorepair - Commander self-repairs at +" .. 11*HP_MULT .. " hp/s. Reduces Health by " .. 100*HP_MULT .. ". Limit: 100",
		image = moduleImagePath .. "module_autorepair.png",
		limit = 100,
		cost = 150 * COST_MULT,
		requireLevel = 1,
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.autorepairRate = (sharedData.autorepairRate or 0) + 11*HP_MULT
			sharedData.healthBonus = (sharedData.healthBonus or 0) - 100*HP_MULT
		end
	},
	{
		...
		description = "Ablative Armour Plates - Provides " .. 750*HP_MULT .. " health. Limit: 100",
	...
	},
	{
		...
		description = "High Density Plating - Provides " .. 2000*HP_MULT .. " health but reduces total speed by 1%. " ..
		...
		applicationFunction = function (modules, sharedData)
			...
			sharedData.speedMultPost = (sharedData.speedMultPost or 1) - 0.01
		end
	},
	{
		name = "module_ablative_armor",
		humanName = "Ablative Armour Plates",
		description = "Ablative Armour Plates - Provides " .. 600*HP_MULT .. " health. Limit: 100",
		image = moduleImagePath .. "module_ablative_armor.png",
		limit = 100,
		cost = 150 * COST_MULT,
		requireLevel = 1,
	...
	},
	{
		name = "module_heavy_armor",
		humanName = "High Density Plating",
		description = "High Density Plating - Provides " .. 1600*HP_MULT .. " health but reduces total speed by 1%. " ..
		"Limit: 5, Requires Ablative Armour Plates",
		image = moduleImagePath .. "module_heavy_armor.png",
		limit = 100,
		cost = 400 * COST_MULT,
	...
	},
	{
		...
		description = "Damage Booster - Increases damage by 20% but reduces total speed by 1%.  Limit: 100",
	...
	},
	{
		...
		description = "High Power Servos - Increases speed by 1 and total speed by 2% and reduced jump cooldown by 1s. Limit: 100",
	...
	},
	{
		name = "module_high_power_servos",
		humanName = "High Power Servos",
		description = "High Power Servos - Increases speed by 1 and total speed by 2%. Limit: 100",
		image = moduleImagePath .. "module_high_power_servos.png",
		limit = 100,
		cost = 200 * COST_MULT,
		requireLevel = 1,
	...
	},
	{
		...
		description = "Advanced Targeting System - Increases range by 7% but reduces total speed by 2%. Limit: 100",
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.rangeMult = (sharedData.rangeMult or 1) + 0.07
			sharedData.speedMultPost = (sharedData.speedMultPost or 1) - 0.02
		end
	},
	{
		...
		description = "CarRepairer's Nanolathe - Increases build power by 6. Limit: 100",
	...
	},
	{
		name = "module_adv_nano",
		humanName = "CarRepairer's Nanolathe",
		description = "CarRepairer's Nanolathe - Increases build power by 5. Limit: 100",
		image = moduleImagePath .. "module_adv_nano.png",
		limit = 100,
		cost = 200 * COST_MULT,
		requireLevel = 1,
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.bonusBuildPower = (sharedData.bonusBuildPower or 0) + 7
		end
	},
	{
		name = "module_adv_nano",
		humanName = "CarRepairer's Nanolathe",
		description = "CarRepairer's Nanolathe - Increases build power by 4. Limit: 100",
		image = moduleImagePath .. "module_adv_nano.png",
		limit = 100,
		cost = 200 * COST_MULT,
		requireLevel = 1,
...
moduleDefs[#moduleDefs + 1] = {
    name = "commweapon_superlaser",
    humanName = "Ray of Doom",
    description = "Отрыжка автоваза",
    image = moduleImagePath .. "weaponmod_high_frequency_beam.png",
    limit = 1,
    cost = 900 * COST_MULT,
    requireChassis = {"support", "recon", "strike", "knight", "assault"},
    requireLevel = 3,
    slotType = "adv_weapon",
    applicationFunction = function(modules, sharedData)
        if sharedData.noMoreWeapons then return end
        if not sharedData.weapon1 then
            sharedData.weapon1 = "commweapon_superlaser"
        else
            sharedData.weapon2 = "commweapon_superlaser"
        end
    end
}
