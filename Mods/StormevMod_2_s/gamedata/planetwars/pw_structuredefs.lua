...
local structureConfig = {
	...
	pw_interception = function(unitDef)
		unitDef.health = 4420
		unitDef.name = "Планетарный перехватчик"
		unitDef.description = "Раскрывает туман войны в большой области. Радар Гигачад :з"
		...
		unitDef.footprintz = 6
		unitDef.metalcost = 900*STRUCTURE_COST_MULT
		...
		unitDef.customparams.unitgroup = "special"
		unitDef.canSelfDestruct = true
		unitDef.reclaimable = true

		unitDef.sightdistance = 2100
		unitDef.radardistance = 2100
		unitDef.radaremitheight = 700
		unitDef.sightemitheight = 700
		unitDef.onoffable = false
		unitDef.energyupkeep = 17.5
	...
	pw_warpjammer = function(unitDef)
		...
		unitDef.description = "Искревляет варп простарнство, можно а зачем?"
		...
		unitDef.footprintx = 8
		unitDef.footprintz = 8
		unitDef.metalcost = 525*STRUCTURE_COST_MULT
		...
		unitDef.customparams.area_cloak_upkeep = 32
		unitDef.customparams.area_cloak_radius = 1000
		unitDef.customparams.area_cloak_decloak_distance = 700
		unitDef.radardistancejam = 1000
		unitDef.onoffable = true
		unitDef.energyupkeep = 6.5
	...
	pw_metal = function(unitDef)
		unitDef.health = 7200
		unitDef.name = "Империал каzИно"
		unitDef.description = "Сыграйте в лучшее казино в галактике. Случайный металл 0-16"
		unitDef.objectname = "pw_mine3.dae"
		unitDef.script = "pw_mine3.lua"
